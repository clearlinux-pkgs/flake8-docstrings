...
Version  : 0.2.8
Release  : 6
URL      : http://pypi.debian.net/flake8-docstrings/flake8-docstrings-0.2.8.tar.gz
Source0  : http://pypi.debian.net/flake8-docstrings/flake8-docstrings-0.2.8.tar.gz
...
%prep
%setup -q -n flake8-docstrings-0.2.8
